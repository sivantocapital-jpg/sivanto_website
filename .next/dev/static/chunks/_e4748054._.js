...
function Footer() {
    _s();
    const [subscribeForm, setSubscribeForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        name: "",
        mobile: ""
    });
    ...
    const validateSubscribe = ()=>{
        const err = {};
        if (!subscribeForm.name.trim()) err.name = "Name is required";
        if (!/^[6-9]\d{9}$/.test(subscribeForm.mobile)) err.mobile = "Valid mobile required";
        setErrors(err);
...
_s(Footer, "cCJ3HZ9F02O++TGuyoYj6zguRrY=");
_c = Footer;
var _c;
...
//# sourceMappingURL=_e4748054._.js.map