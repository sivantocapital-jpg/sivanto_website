  ...
  const faq = [
    {
      ...
      answer:
        "Loan Against Property (LAP) is a secured loan where your property acts as collateral. It provides higher loan amounts and lower interest rates compared to unsecured loans.",
    },
    {
      question: "How much loan can I get?",
      answer:
        "Loan amount depends on property value, location, and applicant profile. Typically, you can get up to 60-70% of the property value.",
    },
    {
      question: "What is the tenure for LAP?",
      answer:
        "Tenure can range up to 15 years depending on the lender and applicant profile.",
    },
    {
      question: "Can I use LAP for business or personal needs?",
      answer:
        "Yes. LAP can be used for business expansion, education, medical emergencies, weddings, and other personal needs.",
    },
  ];
